...
module "layer4_listener" {
  ...
  layer4_listener_id                    = var.layer4_listener_id
  layer4_listener_name                  = var.layer4_listener_name
  layer4_listener_port                  = var.layer4_listener_port
  layer4_listener_protocol              = var.layer4_listener_protocol
  layer4_listener_realserver_type       = var.layer4_listener_realserver_type
  layer4_listener_health_check          = var.layer4_listener_health_check
  layer4_listener_health_check_interval = var.layer4_listener_health_check_interval
  layer4_listener_connect_timeout       = var.layer4_listener_connect_timeout
  layer4_listener_scheduler             = var.layer4_listener_scheduler

  layer4_listener_realserver_ids     = module.realserver.realserver_ids
  layer4_listener_realserver_address = concat(var.realserver_ips, var.realserver_domains)
  layer4_listener_realserver_ports   = module.realserver.realserver_bind_ports
  layer4_listener_realserver_weights = module.realserver.realserver_bind_weights
}
